...
public interface NodeMetadata extends
	 ...
	 * destroy commands are scoped to group.
	 * 
	...
	/**
	 * @return the TCP port used for terminal connections. Generally, this is
	 *         port 22 for ssh.
	 */
	int getLoginPort();
	 ...
	 * often the case that credentials are only available when a node is
	 * initially created.
	 * 
